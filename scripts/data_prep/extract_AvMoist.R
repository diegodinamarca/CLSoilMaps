...
files = dir(here("results","postproc","v1","ROSETTA_MEAN"), full.names = TRUE);files
ha.files = files[grep("AvMoist",files)]

ha = rast(ha.files[c(1,5,3,4,6,2)])

# Load soil database ------------------------------------------------------
fname = here("proc","soil_database","standard","HA_standard.csv")
